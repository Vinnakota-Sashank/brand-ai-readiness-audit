...
| Field | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| `id` | String | Yes | Unique finding identifier formatted strictly as `F-XXX` (e.g., `F-001`, `F-002`). Must match regex `^F-[0-9]{3,}$`. Never use dot-separated taxonomy strings like `CONTENT.MISSING_MECHANISMS.001` here. |
...
- `id` (string): Strictly formatted as `F-XXX` matching regex `^F-[0-9]{3,}$` (e.g., "F-001", "F-002"). Never use dot-separated taxonomy strings (such as CONTENT.MISSING_MECHANISMS.001).
- `title` (string)
